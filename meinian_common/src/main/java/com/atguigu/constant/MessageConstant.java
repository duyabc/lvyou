...
public class MessageConstant {
    ...
    public static final String GET_TRAVELGROUP_DETAIL_FAIL = "查询跟团游数据失败";
    public static final String GET_TRAVELGROUP_DETAIL_SUCCESS = "查询跟团游数据成功";
    public static final String DELTE_SETMEAL_FAIL = "删除套餐游失败";
